...
namespace Game
{
    public class World
    {
        ...
        public World()
        {
            ...
            map.AddEntity(new Prop(Textures.ComputerDesk, PropAngle.Angle90) { Position = new Vector2(100, 0) });
            map.AddEntity(new Prop(Textures.ComputerDesk, PropAngle.Angle270) { Position = new Vector2(-50, 0) });
            map.AddEntity(new Prop(Textures.ComputerDesk, PropAngle.Angle180) { Position = new Vector2(0, 50) });
            map.AddEntity(new Prop(Textures.ComputerDesk, PropAngle.Angle0) { Position = new Vector2(0, -50) });
        }
